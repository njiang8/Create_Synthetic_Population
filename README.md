...
This project contains all functions that create synthetic population in NY, NJ, CT, and PA areas. Our methods use open-source data to generate synthetic population as the table shown below.
